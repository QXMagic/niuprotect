...
public class ApkTools {
    public static List<String> getNullSystemPackageNames() {
        ...
        for (ResolveInfo resolveInfo : resolveInfos) {
            ...
            try {
                PackageManager pm = Constants.MainInstance.getContext().getPackageManager();
    ...
    private static List<ResolveInfo> loadApps() {
        ...
        List<ResolveInfo> apps = Constants.MainInstance.getContext().getPackageManager().queryIntentActivities(intent, 0);
        return apps;
    }
