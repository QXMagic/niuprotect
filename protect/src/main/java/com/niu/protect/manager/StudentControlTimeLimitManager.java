...
public class StudentControlTimeLimitManager {
    ...
    public ParentLimiteTimeModel getParentLimiteHoliday() {
        if (this.mParentLimiteHoliday == null) {
            String parentLimteMsg = (String) SharedPreUtil.getParam(Constants.MainInstance.getContext(), SharedPreManager.KEY_PARENT_HOLIDAY, "");
    ...
    public ParentLimiteTimeModel getmParentLimiteSchool() {
        if (this.mParentLimiteSchool == null) {
            String parentLimteMsg = (String) SharedPreUtil.getParam(Constants.MainInstance.getContext(), SharedPreManager.KEY_PARENT_SCHOOL, "");
            if (!TextUtils.isEmpty(parentLimteMsg)) {
    ...
    public ParentLimteTimeByAppModel getmParentLimteTimeByAppModel() {
        if (this.mParentLimteTimeByAppModel == null) {
            String parentLimteMsg = (String) SharedPreUtil.getParam(Constants.MainInstance.getContext(), SharedPreManager.KEY_OTHER_LIMIT_TIME, "");
            if (!TextUtils.isEmpty(parentLimteMsg)) {
    ...
    public TeacherLimiteTimeModel getmTeacherLimiteTimeModel() {
        if (this.mTeacherLimiteTimeModel == null) {
            String parentLimteMsg = (String) SharedPreUtil.getParam(Constants.MainInstance.getContext(), SharedPreManager.KEY_CONTROL_TEACHER, "");
            if (!TextUtils.isEmpty(parentLimteMsg)) {
