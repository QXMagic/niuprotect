...
public class SecureUtils {
        public static DevicePolicyManager m24088() {
            return (DevicePolicyManager) App.mContext.getSystemService(Context.DEVICE_POLICY_SERVICE);
        }
    ...
    public static boolean m14880(String str) {
        return isOwnerApp() && Build.VERSION.SDK_INT >= 24 && m24088().getUserRestrictions(m24082()).get(str) != null;
    }
    ...
    public static boolean isOwnerApp() {
        ...
        public static boolean m24084() {
            try {
                return m24088().isProfileOwnerApp(App.mContext.getPackageName());
            } catch (Throwable unused) {
                return false;
            }
        }
        ...
        public static ComponentName m24082() {
            ...
            return Tools.m22771(App.mContext);
        }
