...
import accessibility.lib.AppSuperMgrBean;
import accessibility.lib.ChildDBManager;
...
public class GuardIntercept extends BaseGuardIntercept {
        ...
        /* renamed from: 肌緭 */
        public static final AtomicLong atomTime = new AtomicLong(System.currentTimeMillis());
...
//        }
        ...
        int r0 = (SecureUtils.isOwnerApp() && SecureUtils.m24091(App.mContext)) ? 1 : 0;
        ...
        public void mo22193() {
            if (AccessibilityHelperService.instance == null && !Tools.m22495(App.mContext) && SecureUtils.m24091(App.mContext)) {
                SecureUtils.m14879(1);
                LogHelper.instance().m27999("无障碍开关开启");
            }
        }
        ...
        public void m22194() {
            DataKV.m25861("upload_app_statue", false);
            DataKV.m25859("lock_data", "");
            DataKV.m15531("super_statue", 0);
            ConfigKey.m27255();
            DataKV.m25863("bindingStatus", false);
            DataKV.m25863("show_loading", false);
            DataKV.m25864("realmeUiVersion", 0.0f);
            ConfigKey.m27238(2);
            ConfigKey.m27239(0);
            Mgr.getStatusMgr().mo23039(true);
        }
...
//            ThreadUtils.runOnUiThreadDelayed(new RunnableC6076(this), 1000L);
        ...
        public boolean mo22198() {
            ...
            if (accessibilityHelperService.rootWindow() != null) {
                return true;
            }
            return z;
        }
...
//            SignalClient.m21756().m21760();
        ...
        /* renamed from: 肌緭 */
        public void mo14182() {
            LogHelper.instance().m27999("allStatusSetEnds");
            if (Mgr.getStatusMgr().mo14471()) {
                Mgr.getGuardMgr().mo23044(true);
            } else if (Mgr.getStatusMgr().mo14472()) {
                Mgr.getGuardMgr().mo23044(false);
            } else {
                Mgr.getGuardMgr().mo14475(false);
            }
        }
        ...
        public void mo22201() {
            try {
                AccessibilityHelperService accessibilityHelperService = AccessibilityHelperService.instance;
                AtomicLong atomicLong = atomTime;
                    ...
                    if (accessibilityHelperService != null) {
                        ...
                        if (z || !SecureUtils.m24091(App.mContext)) {
                            if (z) {
                                ...
                                LogHelper.instance().m27999("无障碍检测，isAccessibilityEnable is Right");
                                return;
                            }
                            return;
                        }
                        LogHelper.instance().m27999("无障碍失效，service!=null,关闭无障碍");
