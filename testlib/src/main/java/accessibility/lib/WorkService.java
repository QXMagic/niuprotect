...
//            if (System.currentTimeMillis() - WorkService.this.f19263 > (DataKV.m25854("location_cycle", 10) * 60 * 1000) + DateUtils.TEN_SECOND) {
//                WorkService.this.f11904.m20881();
//            }
//        }
//
...
//            DataKV.m25856("current_time", System.currentTimeMillis());
...
//            WorkService.this.m19936();
//            if (System.currentTimeMillis() - WorkService.this.f19263 > (DataKV.m25854("location_cycle", 10) * 60 * 1000) + 600000) {
...
//        if (event.getUid() != 0) {
//            DataKV.m15531("parent_uid", event.getUid());
//        }
...
//                            DataKV.m25859("lock_tem_data", GsonUtils.toJson(lockTemInfoBean));
//                            this.f19257.m21563();
//                            return;
//                        }
//                        return;
...
//                Mgr.m24658().mo22193();
//                Mgr.m24658().mo22206();
//                long m25860 = DataKV.m25860("update_app_time", 0L);
//                long currentTimeMillis = System.currentTimeMillis();
//                if (currentTimeMillis - m25860 > 300000) {
//                    DataKV.m25855("update_app_time", currentTimeMillis);
//                    this.f19255.m15588();
//                    this.f19255.m26073();
//                }
//                try {
...
//                                DataKV.m25859("child_c_d_id", connectBean.getD_id());
...
//                if (ObjectUtils.isNotEmpty((CharSequence) extra)) {
//                    try {
//                        DataKV.m15531("location_cycle", new JSONObject(extra).optInt("intervalTime"));
//                        this.f11904.m20879();
//                        return;
//                    } catch (Exception e6) {
//                        e6.printStackTrace();
...
//                    if (DataKV.m25854("groupTime", TimeConstants.HOUR) != optLong) {
//                        DataKV.m25855("groupTime", optLong);
//                        this.f19266.m25888();
//                        this.f19265.m22959();
//                        return;
//                    }
