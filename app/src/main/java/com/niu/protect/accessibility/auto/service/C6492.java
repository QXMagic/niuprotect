...
public class C6492 {
    ...
    /* renamed from: 刻槒唱镧詴 */
    public void m24468(InterfaceC6494 interfaceC6494) {
    ...
    public void m24469(InterfaceC6494 interfaceC6494) {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ObjectUtils.equals(this.f13582, "android.intent.action.USER_PRESENT")) {
                ...
                if (NetWorkUtils.m14317()) {
                    LogHelper.m27986().m16303("手机状态", "网络已连接");
                ...
                LogHelper.m27986().m16303("手机状态", "网络未连接");
