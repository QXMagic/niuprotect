...
public class OppoColorsInfo_31 extends BaseCreatePageInfo {
    ...
    public List<PageInfoModel> createPage(Context context) {
        ...
        PageInfoModel pInfoPowerDetail = createLastPage("3985学生端", 1, 3, 1, "耗电管理", 2);
        ...
        PageInfoModel pInfoPremCenter = createLastPage("3985学生端", 1, 5, 2, "通知管理", 2);
        ...
        PageInfoModel pInfoFloatViewCenter = createParentPage("悬浮窗", "3985学生端", 2, 7);
        childinfoModels.add(pInfoFloatViewCenter);
        PageInfoModel pInfoFloatViewSetting = createLastPage("3985学生端", 2, 8, 1, "设置悬浮窗权限", 5);
        ...
        PageInfoModel pInfoCenterAPPUse = createCenterPage("使用情况", "3985学生端", 3, 10);
