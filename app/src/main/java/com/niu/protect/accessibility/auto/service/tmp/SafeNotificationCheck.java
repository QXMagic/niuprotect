...
import com.niu.protect.accessibility.auto.service.AccessibilityEventImpl;
...
public class SafeNotificationCheck extends ContextWrapper {
    ...
    public final void m14526(AccessibilityEventImpl accessibilityEventImpl, @Nullable Notification notification) {
        try {
            if (accessibilityEventImpl.m15019() != null) {
                if ((notification != null ? notification.contentIntent : null) == null || ObjectUtils.equals(accessibilityEventImpl.m15019(), getPackageName()) || !m23169(accessibilityEventImpl.m15019().toString())) {
                    return;
                }
