...
public class OppoAccessibility2 extends BaseAccessibility {
    ...
    private void settingBreeno(int eventType, String packageName, String className) {
        if (packageName.equals("com.android.settings") && className.equals(OppoDeviceInfo.StepOneBreeno.SETTING_Class_name)) {
