...
public class AppActivityTool {
    ...
    public static void showSetActivy(Context context) {
        Intent intent = new Intent();
        ComponentName cn2 = new ComponentName(BuildConfig.APPLICATION_ID, "com.niu.protect.ui.setting.SysSetActivity");
        intent.setComponent(cn2);
        ...
        Uri uri = Uri.parse("com.niu.protect.ui.setting.SysSetActivity");
        intent.setData(uri);
