...
public class OppoDeviceInfo {
    ...
    public static final class StepOneBreeno {
        public static final String BREENO = "Breeno";
        public static final String BREENO_Click_Text = "Breeno 速览";
        public static final String BREENO_setting_PackageName = "com.coloros.sceneservice";
        public static final String BREENO_setting_class = "com.coloros.sceneservice.settings.SettingsActivity";
        public static final String SETTING_Class_name = "com.coloros.settings.feature.homepage.ColorSettingsHomepageActivity";
        public static final String SETTING_PackageName = "com.android.settings";
        public static boolean STATUS_CLICKED = true;
        public static final int Step_one_Breeno = 1;
    }
