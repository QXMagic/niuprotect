...
//                C6891.m25861("setting_intercept", false);
...
//        this.f23172 = new AtomicBoolean(ConfigKey.m16030());
        this.f23176 = new AtomicBoolean(Mgr.m15110().mo14472());
...
//        if (C6891.m25858("setting_intercept", false)) {
...
//            C6891.m25856("current_time", currentTimeMillis);
