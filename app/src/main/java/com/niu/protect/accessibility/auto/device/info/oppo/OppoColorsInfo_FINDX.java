...
public class OppoColorsInfo_FINDX extends BaseCreatePageInfo {
    @Override
    protected BaseCreatePageInfo createInfo() {
        return new OppoColorsInfo_FINDX();
    }
    ...
    public List<PageInfoModel> createPage(Context context) {
        ...
        PageInfoModel pInfoPowerSetting = createCenterPage("应用信息", "耗电管理", 2, 5);
        childinfoModels.add(pInfoPowerSetting);
        PageInfoModel pInfoPowerDetail = createLastPage(AppInfo.getAppName(context), 2, 6, 1, "耗电管理", 2);
        ...
        PageInfoModel pInfoCenterAPPUse = createCenterPage("使用", AppInfo.getAppName(context), 3, 11);
