 ...
 */
    ...
    /* loaded from: C:\Users\PC\Downloads\bfa4c7ece67b6eaa51d4653201f6959f.zip\classes5.dex */
    public class C4480 implements OprateManager.InterfaceC7201 {
        public C4480() {
        }
...
//            C4472.m16173(this, str, str2, z);
    ...
    public static CommonPermission m27699() {
        if (f24288 == null) {
            synchronized (CommonPermission.class) {
                f24288 = new MiuiAccessibility();
            }
        }
        return f24288;
    }
    ...
    public boolean mo27704() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            AccessibilityNodeInfo m27688 = this.f14817.m27688();
            AccessibilityNodeInfo m27671 = this.f14817.m27671(m27688, "android:id/checkbox", new String[]{"USB 调试", "USB调试"});
            if (m27671 == null) {
                m27671 = this.f14817.m27671(m27688, "android:id/switch_widget", new String[]{"USB 调试", "USB调试"});
            }
            if (this.f14817.m27692(m27671)) {
                if (!ObjectUtils.equals("开启", m27671.getContentDescription()) && !m27671.isChecked()) {
                    ...
                    if (RomUtil.isMiui()) {
                        List<AccessibilityNodeInfo> m16183 = this.f14817.m16183("确定");
                        if (m16183 != null && !m16183.isEmpty()) {
                            AccessibilityNodeInfo accessibilityNodeInfo = m16183.get(0);
                            m16175("确定", accessibilityNodeInfo);
                            accessibilityNodeInfo.performAction(16);
                        }
                    } else {
                        List<AccessibilityNodeInfo> m161832 = this.f14817.m16183("确定");
    ...
    public boolean mo27707() {
        return false;
    }

    /* renamed from: 鞲冇 */
    public boolean mo16172() {
        return false;
    }

    /* renamed from: 韐爮幀悖罤噩钼遑杯盇 */
    public boolean mo27620() {
        return false;
    }
