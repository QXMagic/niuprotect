...
import com.niuniu.babyprotect.model.TeacherLimiteTimeModel;
...
public class StudentMainController {
    ...
    public void requestMainControl() {
        ...
        UserInfoManager.getInstance().refreshUserInfo(BabyApplication.getInstance(), new UserInfoManager.OnSuccessCallBack() {
            @Override
            public void onSuccess() {
                requstWeekControlTime(BabyApplication.getInstance());
            }
        });
    }
