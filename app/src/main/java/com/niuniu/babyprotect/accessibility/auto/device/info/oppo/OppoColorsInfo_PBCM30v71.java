...
public class OppoColorsInfo_PBCM30v71 extends BaseCreatePageInfo {
    @Override
    protected BaseCreatePageInfo createInfo() {
        return new OppoColorsInfo_PBCM30v71();
    }
    ...
    public List<PageInfoModel> createPage(Context context) {
        ...
        PageInfoModel pInfoCenterAPPUse = createCenterPage("使用情况", AppInfo.getAppName(context), 3, 11);
