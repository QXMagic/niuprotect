...
public class Vivo_Info_13 extends BaseCreatePageInfo {
    @Override
    protected BaseCreatePageInfo createInfo() {
        return new Vivo_Info_13();
    }
    ...
    public List<PageInfoModel> createPage(Context context) {
        ...
        PageInfoModel pInfoPremCenter = createCenterPage("应用权限", "所有权限", 1, 5);
        ...
        PageInfoModel pInfoMinePowerCenter = createCenterPage("电池", "后台耗电管理", 4, 12);
        childinfoModels.add(pInfoMinePowerCenter);
        PageInfoModel pInfoPowerAppList = createCenterPage("后台耗电管理", AppInfo.getAppName(context), 4, 13);
        childinfoModels.add(pInfoPowerAppList);
        PageInfoModel pInfoPowerDetail = createLastPage("后台耗电管理", 4, 14, 4, "高耗电量", 1);
